...
// route come with reactNavigation
...
const ItemScreen = ({ route }) => {
  ...
  return (
    <View className='flex-1 bg-white relative'>
      <ScrollView className='felx-1 px-4 py-6'>
        <View className='relative bg-white shadow-lg'>
          ...
          <View className='absolute flex-row inset-x-0 bottom-5 justify-between px-6'>
            <View className='flex-wrap-reverse space-x-2 items-center'>
              <Text className='text-[12px] font-black text-gray-100'>
                {data?.price_level}
              </Text>
              <Text className='text-[32px] font-black text-gray-100'>
                {data?.price}
              </Text>
            </View>
